...
public class Solution {
    ...
    private boolean isValidBase(String s) {
        ...
        if (dotIndex != -1) {
            ...
            // Ensure at least one side of the dot is a valid number part
            return (isValidInteger(left, true) || left.isEmpty()) && (isValidInteger(right, false) || right.isEmpty()) && !(left.isEmpty() && right.isEmpty());
        } else {
